...
public class OrderApplicationService(IUnitOfWork unitOfWork, IMapper mapper) : IOrderApplicationService
{
    ...
    {
        var orders = await unitOfWork.Orders.ListAllAsync(cancellationToken);
    ...
    {
        var orders = await unitOfWork.Orders.ListAsync(o => o.CustomerId == customerId, cancellationToken);
